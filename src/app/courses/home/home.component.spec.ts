...
fdescribe('HomeComponent', () => {
  ...
  let tabs = el.queryAll(By.css('.mdc-tab'))
  ...
  it("should display both tabs", () => {
    ...
    fixture.detectChanges();
    let tabs = el.queryAll(By.css('.mdc-tab'))
    expect(tabs.length).toBe(2, 'expect 2 tabs')
  ...
  //async test zone works differnt than fakeAsync 
  //keep track of the async test zones, use a callback to notify-  fixture.whenStable().then
  // fakeAsync preferred over async ===> support only actual http calls example intergration tests
  ...
  it("should display advanced courses when tab clicked- waitforasync", waitForAsync(() => {
    ...
    fixture.whenStable().then(()=>{
      console.log("wait for async assertion")
      const cardTitles = el.queryAll(By.css('.mat-mdc-tab-body-active .mat-mdc-card-title'));
